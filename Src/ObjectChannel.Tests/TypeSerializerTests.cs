namespace ObjectChannel.Tests
{
    ...
    public class TypeSerializerTests
    {
        ...
        public void GetPersonTypeFullName()
        {
            ...
            Assert.AreEqual("ObjectChannel.Tests.Person", serializer.TypeName);
        }
        ...
        public void CreateSerializerByFullNameAndProperties()
        {
            ...
            var serializer = new TypeSerializer("ObjectChannel.Tests.Person", properties);
